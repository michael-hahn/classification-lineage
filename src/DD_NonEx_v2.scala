...
class DD_NonEx_v2[T:ClassTag] {
  ...
  def ddgen(inputRDD: RDD[T], testFunc: userTest[T], splitFunc: userSplit_v2[T], maxClusters: Int, totalClusters: Int, centroid_ref: Array[Cluster], lm: LogManager, fh: FileHandler): RDD[T] = {
